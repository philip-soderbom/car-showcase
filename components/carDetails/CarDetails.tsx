                            ...
                            >
                                ...
                                text-left shadow-xl transition-all flex flex-col gap-5 p-6">
                                    <button
                                        ...
                                        className='absolute top-2 right-2 w-fit z-10 p-2 bg-primary-blue-100 rounded-full'
                                    >
                                        <Image
                                            src="/close.svg"
                                            width={20}
                                    ...
                                    <div className='flex flex-1 flex-col gap-3'>
                                        ...
                                        <div className='flex gap-3'>
                                            <div className="flex-1 relative w-full h-24 bg-primary-blue-400 rounded-lg">
                                                <Image src="/hero.png" fill priority alt="car model" className="object-contain" />
                                            </div>
                                            <div className="flex-1 relative w-full h-24 bg-primary-blue-400 rounded-lg">
                                                <Image src="/hero.png" fill priority alt="car model" className="object-contain" />
